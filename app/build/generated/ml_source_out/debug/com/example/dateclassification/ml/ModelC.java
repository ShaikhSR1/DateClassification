package com.example.dateclassification.ml;
...
public final class ModelC {
  @NonNull
  private final Model model;

  private ModelC(@NonNull Context context, @NonNull Model.Options options) throws IOException {
    model = Model.createModel(context, "modelC.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static ModelC newInstance(@NonNull Context context) throws IOException {
    return new ModelC(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static ModelC newInstance(@NonNull Context context, @NonNull Model.Options options) throws
      IOException {
    return new ModelC(context, options);
  }
